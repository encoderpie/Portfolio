        ...
        <>
            <div className='w-100 p-3 bg-gray-900'>
                <div className='container flex flex-wrap font-medium justify-between items-center mx-auto'>
                    ...
                    <button onClick={()=>setHamburgerMenuOpen(!hamburgerMenuOpen)} className='block lg:hidden rounded-lg bg-slate-800 p-2 hover:bg-slate-800/50 transition-all'>
                        {hamburgerMenuOpen ? <CgClose /> : <FiMenu />}
                    </button>
            ...
            <div className={`w-100 p-3 bg-slate-900 ${hamburgerMenuOpen ? 'block' : 'hidden'}`}>
                <ul className='border rounded-lg border-slate-800 py-1 px-2'>
                    <li>
                    ...
                    <li>
                        <a className="text-gray-400 hover:text-slate-100" href="/#aboutme">
                            About Me
                        </a>
                    </li>
                    <li>
                        <a className="text-gray-400 hover:text-slate-100" href="/#skills">
                            Skills
                        </a>
                    </li>
                    <li>
                        <a className="text-gray-400 hover:text-slate-100" href="/#contact">
                            Contact
                        </a>
                    </li>
                </ul>
